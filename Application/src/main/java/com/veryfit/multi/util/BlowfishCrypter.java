...
public class BlowfishCrypter implements Crypter {
    ...
    public BlowfishCrypter(String bfkey) {
        setKey(bfkey);
    }

    public BlowfishCrypter(byte[] bfkey) {
        setKey(bfkey);
    }
        ...
        if (nLen != 0 && nLen <= 56) {
            ...
            for (nI = 0; nI < 18; nI++) {
                for (int nJ = 0; nJ < 4; nJ++) {
                    nBuild = (nBuild << 8) | (bytes[nKeyPos] & MotionEventCompat.ACTION_MASK);
                    nKeyPos++;
                    if (nKeyPos == nLen) {
                        nKeyPos = 0;
                    }
                ...
                iArr[nI] = iArr[nI] ^ nBuild;
            }
            SBlock b = new SBlock(0, 0);
            for (nI = 0; nI < 18; nI += 2) {
                b = encryptBlock(b);
                this.m_pbox[nI] = b.m_Hi;
                this.m_pbox[nI + 1] = b.m_Lo;
            }
            for (nI = 0; nI < 256; nI += 2) {
                b = encryptBlock(b);
                this.m_sbox1[nI] = b.m_Hi;
                this.m_sbox1[nI + 1] = b.m_Lo;
            }
            for (nI = 0; nI < 256; nI += 2) {
                b = encryptBlock(b);
                this.m_sbox2[nI] = b.m_Hi;
                this.m_sbox2[nI + 1] = b.m_Lo;
            }
            for (nI = 0; nI < 256; nI += 2) {
                b = encryptBlock(b);
                this.m_sbox3[nI] = b.m_Hi;
                this.m_sbox3[nI + 1] = b.m_Lo;
            }
            for (nI = 0; nI < 256; nI += 2) {
                b = encryptBlock(b);
                this.m_sbox4[nI] = b.m_Hi;
                this.m_sbox4[nI + 1] = b.m_Lo;
            }
        }
    }
    ...
    protected SBlock encryptBlock(SBlock b) {
        ...
        nHi ^= pbox[0];
        nLo ^= (((sbox1[nHi >>> 24] + sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ pbox[1];
        nHi ^= (((sbox1[nLo >>> 24] + sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ pbox[2];
        nLo ^= (((sbox1[nHi >>> 24] + sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ pbox[3];
        nHi ^= (((sbox1[nLo >>> 24] + sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ pbox[4];
        nLo ^= (((sbox1[nHi >>> 24] + sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ pbox[5];
        nHi ^= (((sbox1[nLo >>> 24] + sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ pbox[6];
        nLo ^= (((sbox1[nHi >>> 24] + sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ pbox[7];
        nHi ^= (((sbox1[nLo >>> 24] + sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ pbox[8];
        nLo ^= (((sbox1[nHi >>> 24] + sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ pbox[9];
        nHi ^= (((sbox1[nLo >>> 24] + sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ pbox[10];
        nLo ^= (((sbox1[nHi >>> 24] + sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ pbox[11];
        nHi ^= (((sbox1[nLo >>> 24] + sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ pbox[12];
        nLo ^= (((sbox1[nHi >>> 24] + sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ pbox[13];
        nHi ^= (((sbox1[nLo >>> 24] + sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ pbox[14];
        nLo ^= (((sbox1[nHi >>> 24] + sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ pbox[15];
        return new SBlock(nHi ^ ((((sbox1[nLo >>> 24] + sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ pbox[16]), nLo ^ pbox[17]);
    }

    protected SBlock decryptBlock(SBlock b) {
        int nHi = b.m_Hi;
        nHi ^= this.m_pbox[17];
        int nLo = b.m_Lo ^ ((((this.m_sbox1[nHi >>> 24] + this.m_sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[16]);
        nHi ^= (((this.m_sbox1[nLo >>> 24] + this.m_sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[15];
        nLo ^= (((this.m_sbox1[nHi >>> 24] + this.m_sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[14];
        nHi ^= (((this.m_sbox1[nLo >>> 24] + this.m_sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[13];
        nLo ^= (((this.m_sbox1[nHi >>> 24] + this.m_sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[12];
        nHi ^= (((this.m_sbox1[nLo >>> 24] + this.m_sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[11];
        nLo ^= (((this.m_sbox1[nHi >>> 24] + this.m_sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[10];
        nHi ^= (((this.m_sbox1[nLo >>> 24] + this.m_sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[9];
        nLo ^= (((this.m_sbox1[nHi >>> 24] + this.m_sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[8];
        nHi ^= (((this.m_sbox1[nLo >>> 24] + this.m_sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[7];
        nLo ^= (((this.m_sbox1[nHi >>> 24] + this.m_sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[6];
        nHi ^= (((this.m_sbox1[nLo >>> 24] + this.m_sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[5];
        nLo ^= (((this.m_sbox1[nHi >>> 24] + this.m_sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[4];
        nHi ^= (((this.m_sbox1[nLo >>> 24] + this.m_sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[3];
        nLo ^= (((this.m_sbox1[nHi >>> 24] + this.m_sbox2[(nHi >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nHi >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nHi & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[2];
        return new SBlock(nHi ^ ((((this.m_sbox1[nLo >>> 24] + this.m_sbox2[(nLo >>> 16) & MotionEventCompat.ACTION_MASK]) ^ this.m_sbox3[(nLo >>> 8) & MotionEventCompat.ACTION_MASK]) + this.m_sbox4[nLo & MotionEventCompat.ACTION_MASK]) ^ this.m_pbox[1]), nLo ^ this.m_pbox[0]);
    }
    ...
    private byte[] encrypt(byte[] buffer) {
        ...
        for (int nI = 0; nI < nLen; nI += 8) {
            M0 = concat(M0, blockToBytes(encryptBlock(bytesToBlock(buffer, nI))));
        }
        return M0;
    }
    ...
    private byte[] decrypt(byte[] buffer) {
        ...
        int nLen = buffer.length;
        for (int nI = 0; nI < nLen; nI += 8) {
            M0 = concat(M0, blockToBytes(decryptBlock(bytesToBlock(buffer, nI))));
        }
        return M0;
    }
    ...
    private SBlock bytesToBlock(byte[] buffer, int nPos) {
        SBlock b = new SBlock();
        b.m_Hi = ((((buffer[nPos] & MotionEventCompat.ACTION_MASK) << 24) | ((buffer[nPos + 1] & MotionEventCompat.ACTION_MASK) << 16)) | ((buffer[nPos + 2] & MotionEventCompat.ACTION_MASK) << 8)) | (buffer[nPos + 3] & MotionEventCompat.ACTION_MASK);
        b.m_Lo = ((((buffer[nPos + 4] & MotionEventCompat.ACTION_MASK) << 24) | ((buffer[nPos + 5] & MotionEventCompat.ACTION_MASK) << 16)) | ((buffer[nPos + 6] & MotionEventCompat.ACTION_MASK) << 8)) | (buffer[nPos + 7] & MotionEventCompat.ACTION_MASK);
        return b;
    }

    private byte[] blockToBytes(SBlock b) {
        return new byte[]{(byte) ((b.m_Hi >>> 24) & MotionEventCompat.ACTION_MASK), (byte) ((b.m_Hi >>> 16) & MotionEventCompat.ACTION_MASK), (byte) ((b.m_Hi >>> 8) & MotionEventCompat.ACTION_MASK), (byte) (b.m_Hi & MotionEventCompat.ACTION_MASK), (byte) ((b.m_Lo >>> 24) & MotionEventCompat.ACTION_MASK), (byte) ((b.m_Lo >>> 16) & MotionEventCompat.ACTION_MASK), (byte) ((b.m_Lo >>> 8) & MotionEventCompat.ACTION_MASK), (byte) (b.m_Lo & MotionEventCompat.ACTION_MASK)};
    }
    ...
    private static byte[] hex2byte(byte[] b, int offset, int len) {
        ...
        for (int i = 0; i < len * 2; i++) {
            int i2 = i >> 1;
            d[i2] = (byte) (d[i2] | (Character.digit((char) b[offset + i], 16) << (i % 2 == 1 ? 0 : 4)));
        }
        return d;
    }
    ...
    public static void main(String[] args) {
        BlowfishCrypter bf = new BlowfishCrypter();
        String encrypted = bf.encrypt("123456dsa暗室逢灯是dfd撒发生地方213243409=-=261&*（*￥%￥%#￥%*（）（）的");
        System.out.println(encrypted);
        System.out.println(bf.decrypt(encrypted));
        System.out.println(bf.decrypt("53E22FE344A020214F92526F30338AD6EE720A0E1C48264D8ED7C30917B3F416"));
    }
}
